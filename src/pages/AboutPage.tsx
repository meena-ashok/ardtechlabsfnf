...
const fallbackTeam = [
  { id: 1, name: "Ashok Meena", role: "CEO & CMO", bio: "Visionary leader driving our mission forward." },
  { id: 2, name: "Suraj J", role: "CTO", bio: "Technology expert leading our engineering team." },
  { id: 3, name: "Neha M", role: "Co-founder & BDM", bio: "Co-founder and business development manager." },
  { id: 4, name: "Viral P", role: "Head of Design", bio: "Creative mind behind our user-centric designs." },
];
const aboutJsonLd = {
  ...
  mainEntity: {
    ...
    areaServed: ["United States", "United Kingdom", "Germany", "France", "Netherlands", "Australia"],
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "Home",
      "item": "https://www.ardtechlabs.com"
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "About Us",
      "item": "https://www.ardtechlabs.com/about"
    }
  ]
};
