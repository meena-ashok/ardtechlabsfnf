...
const fallbackServices = [
  ...
  { id: 3, icon: "Brain", variant: "orange", title: "AI & Machine Learning", description: "NLP, computer vision, predictive analytics, and LLM integrations that automate and enhance your business.", chips: "OpenAI,LangChain,TensorFlow,PyTorch" },
  ...
  { id: 5, icon: "RefreshCw", variant: "orange", title: "DevOps & CI/CD", description: "Streamlined pipelines, infrastructure as code, container orchestration, and automated testing.", chips: "Docker,Kubernetes,GitHub Actions,Jenkins" },
  ...
  { id: 8, icon: "Palette", variant: "navy", title: "UI/UX Design", description: "User-centred design, prototypes, design systems, and usability research creating delightful experiences.", chips: "Figma,Design Systems,Prototyping,Research" },
];
